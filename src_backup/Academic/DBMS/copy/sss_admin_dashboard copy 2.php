...
if ($_POST && isset($_POST['action']) && $_POST['action'] == 'delete_supervisor') {
    $user_id = isset($_POST['user_id']) ? intval($_POST['user_id']) : 0;
    
    if ($user_id > 0) {
        $unassign = "UPDATE building SET supervisor_id = NULL WHERE supervisor_id = $user_id";
        $conn->query($unassign);
        
        $delete = "DELETE FROM users WHERE user_id = $user_id AND role = 'Supervisor'";
...
if ($_POST && isset($_POST['action']) && $_POST['action'] == 'delete_resident') {
    $resident_id = isset($_POST['resident_id']) ? intval($_POST['resident_id']) : 0;
    $user_id = isset($_POST['user_id']) ? intval($_POST['user_id']) : 0;
    
    if ($resident_id > 0 && $user_id > 0) {
        $delete1 = "DELETE FROM resident_details WHERE resident_id = $resident_id";
        
        if ($conn->query($delete1)) {
            $delete2 = "DELETE FROM users WHERE user_id = $user_id";
            ...
            $message = "Error deleting resident details: " . $conn->error;
        }
    }
}

if ($_POST && isset($_POST['action']) && $_POST['action'] == 'delete_staff') {
    $staff_id = isset($_POST['staff_id']) ? intval($_POST['staff_id']) : 0;
    
    if ($staff_id > 0) {
        $delete = "DELETE FROM staff_details WHERE staff_id = $staff_id";
...
$supervisors = $conn->query("SELECT * FROM users WHERE role = 'Supervisor' ORDER BY user_id DESC");
$buildings = $conn->query("SELECT * FROM building ORDER BY building_id DESC");
$flats = $conn->query("SELECT f.*, b.building_name FROM flat_details f LEFT JOIN building b ON f.building_id = b.building_id ORDER BY f.flat_id DESC");
$residents = $conn->query("SELECT r.resident_id, r.flat_id, r.user_id, r.resident_name, r.phone_number, r.email, f.flat_number, b.building_name, u.username 
...
$staff_members = $conn->query("SELECT * FROM staff_details ORDER BY staff_id DESC");
?>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .delete-btn { background: #e74c3c !important; padding: 5px 10px; font-size: 12px; }
...
<body>
    <div class="container">
        <div class="sidebar">
            ...
            <div class="nav-item active" onclick="showSection('add-resident')">Add Resident</div>
            ...
            <div class="nav-item" onclick="showSection('view-staff')">View Staff</div>
            <hr style="margin: 15px 0; opacity: 0.3;">
        ...
        <div class="main-content">
            ...
            <div id="add-resident" class="section active">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" style="display:inline;">
                                ...
                                <button type="submit" class="delete-btn" onclick="return confirm('Delete this supervisor?')">Delete</button>
                            </form>
                        </td>
                    </tr>
                    <?php endwhile; ?>
            ...
            <div id="view-residents" class="section">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['username']); ?></td>
                        <td><?php echo htmlspecialchars($row['building_name'] ?: 'N/A'); ?></td>
                        <td><?php echo htmlspecialchars($row['flat_number'] ?: 'N/A'); ?></td>
                        ...
                        <td>
                            <form method="POST" style="display:inline;">
                                ...
                                <input type="hidden" name="user_id" value="<?php echo $row['user_id']; ?>">
                                <button type="submit" class="delete-btn" onclick="return confirm('Delete this resident?')">Delete</button>
                            </form>
                        </td>
                    </tr>
                    <?php endwhile; ?>
            ...
            <div id="view-staff" class="section">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" style="display:inline;">
                                ...
                                <button type="submit" class="delete-btn" onclick="return confirm('Delete this staff member?')">Delete</button>
                            </form>
                        </td>
                    </tr>
                    <?php endwhile; ?>
