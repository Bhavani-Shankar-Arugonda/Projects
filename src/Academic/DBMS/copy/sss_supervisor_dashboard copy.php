...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_regular_visitor'])) {
    ...
    $sql = "INSERT INTO regular_visitors_vendors (name, phone_number, category, security_code, is_active) 
            VALUES ('$visitor_name', '$visitor_phone', '$category', 'SEC-" . strtoupper(substr(md5(time() . rand()), 0, 6)) . "', 1)";
...
// Fetch all regular visitors/vendors (after any delete operations)
if ($regular_visitors) {
...
// Fetch maintenance details for all flats in supervisor's buildings
